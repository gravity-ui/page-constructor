...
## [<s>SliderOld</s>](?path=/story/blocks-sliderold-deprecated--docs&viewMode=docs) (Deprecated, use SliderNew instead)

## [SliderNew](?path=/story/lab-slidernew--docs&viewMode=docs)
