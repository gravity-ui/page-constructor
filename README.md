...
5. Field with types of version (prepatch | preminor). Default value is preminor. You can use for the first time to up package version properly. Do not set up anything here if you want to increase only version after `alpha`.
