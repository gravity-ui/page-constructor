...
- `theme?: 'blue' | 'grey' | 'custom'` — Play button theme. The custom theme reads colors from `projectSettings.defaultVideoButtonSettings`; content JSON Schema currently accepts only `blue | grey`.
