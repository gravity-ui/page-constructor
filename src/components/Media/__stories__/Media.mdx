...
For a detailed usage guide of the MediaImage component (used within Media), see [MediaImage Usage](https://github.com/gravity-ui/page-constructor/blob/main/memory-bank/usage/mediaImage.md).
