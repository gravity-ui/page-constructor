...
- `size?: 's' | 'm' | 'l' | 'xl'` — Cube size that defines font sizes ('l' by default)
- `background?: BackgroundImage` — Special background properties described in the **Content blocks** section. Supports different values for themes
