...
// TODO: remove imports from editor-v2
import {ZOOM_STEPS} from '../editor-v2/constants';
import {
    duplicateArrayItem,
...
export interface EditorMethods {
    ...
    setContent(data: PageContent): void;
