...
For a detailed usage guide of the ImageCard component, see [ImageCard Usage](https://github.com/gravity-ui/page-constructor/blob/main/memory-bank/usage/imageCard.md).
...
`analyticsEvents?: AnalyticsEvent | AnalyticsEvent[]` — Analytics event or list of events fired on card click (only when `url` is provided). See [AnalyticsEvent](?path=/docs/documentation-types--docs#analyticsevent).
